...
public class SecondFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (position+1 == 1){
            myTextView.setText("Graphic design, also known as communication design, is the art and practice of planning and projecting ideas and experiences with visual and textual content" );// pour incrementer quand on clique


        }else if (position+1 ==2){

            myTextView.setText("A programmer is a person who writes computer programs, a person who programs a device, especially a computer. " );// pour incrementer quand on clique
